...
```
pkcs11:token=corvus;object=byok-kek?module-path=/usr/lib64/softhsm/libsofthsm2.so&pin-source=/hsm/tokens/hsm-pin
```
...
```
pkcs11:token=corvus;object=byok-kek?module-path=/usr/lib64/softhsm/libsofthsm2.so&pin-source=/run/secrets/hsm-pin
```

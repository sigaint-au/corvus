-- Rename PL/pgSQL variable folder_id -> v_folder_id in machine_upsert_enc.
-- The 0007 body declared folder_id, which shadows api.secrets.folder_id and
-- makes ON CONFLICT (..., folder_id, ...) raise AmbiguousColumn (HTTP 500)
-- for slash-separated keys such as hosts/<host>/users/root.
